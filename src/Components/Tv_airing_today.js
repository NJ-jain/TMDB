  ...
  const getPopular = async (page) => {
    try {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/tv/airing_today?api_key=223667d1239871fc4b6eeef8d0d6def8&language=en-US&page=${page}`
      );
...
export default Tv_airing_today